...
delete a[c]}}b.extend(k[j],a);k[j].hsl=b.colors.models.HSL.sanitize(k[j].hsl).slice(0,3);t(n);if("disabled"in a)a.disabled?l.addClass("disabled"):l.removeClass("disabled")}else a==="hsl"&&d.push(f);v()});return d.length>1?d:d.length==1?d[0]:e};if(b.colors.pickers===undefined)b.colors.pickers={};var r=b("script");r=r.eq(r.length-1).attr("src").split("/");r.pop();b.colors.pickers.hslLite={pathToImages:r.join("/")+"/"}})(jQuery);
